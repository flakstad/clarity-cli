...
func TestRenderItemDetailInteractive_SmallHeight_ShowsScrollIndicators(t *testing.T) {
	...
	out0 := renderItemDetailInteractive(db, outline, it, 42, 10, itemFocusTitle, nil, 0, 0, 0, 0, 0, 0, 0)
	...
	out1 := renderItemDetailInteractive(db, outline, it, 42, 10, itemFocusTitle, nil, 0, 0, 0, 0, 0, 0, 10)
